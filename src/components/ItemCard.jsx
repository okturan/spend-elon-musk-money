...
function ItemCard({ id, item, budget, dispatch }) {
  return (
    <div className="border rounded-lg shadow flex flex-col items-center justify-between h-96">
      ...
      <div className="flex px-4 pb-6 items-center w-full space-x-4">
        ...
        <output className="text-xl font-semibold text-center" aria-live="polite" aria-label={`${item.name} quantity`}>
          {item.quantity}
        </output>
